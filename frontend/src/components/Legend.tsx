...
export default function Legend({ activeLayer }) {
  ...
  return (
    <div className="fixed md:absolute bottom-14 left-3 md:bottom-6 md:left-auto md:right-[380px] bg-white/92 backdrop-blur-md rounded-lg border border-black/8 shadow-sm px-3 py-2.5 flex flex-col gap-1 text-[11px] text-gray-900 z-10">
