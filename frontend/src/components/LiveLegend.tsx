...
export default function LiveLegend() {
  return (
    <>
      ...
      <div className="md:hidden fixed bottom-[68px] left-3 right-3 bg-white/92 backdrop-blur-md rounded-lg border border-black/8 shadow-sm px-3 py-2 flex items-center gap-3 z-10 text-[10px]">
        {STATION_COLORS.map(({ color, label }) => (
