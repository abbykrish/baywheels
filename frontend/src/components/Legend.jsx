...
export default function Legend({ activeLayer }) {
  ...
  return (
    <div className="absolute bottom-6 left-80 bg-white/92 backdrop-blur-md rounded-lg border border-black/8 shadow-sm px-3 py-2.5 flex flex-col gap-1 text-[11px] text-gray-900">
